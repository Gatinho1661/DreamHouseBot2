...
module.exports = {
  ...
  async executar(iCmd, opcoes) {
    ...
    switch (opcoes.subComando) {
      ...
      case "usuario": {
        ...
        if (!cor) {
          return client.responder(
            ...
            "bloqueado",
            "Nenhuma cor",
            "Essa pessoa não tem uma cor definida"
          );
        }
      ...
      case "cargo": {
        ...
        if (!cor) {
          return client.responder(
            ...
            "bloqueado",
            "Nenhuma cor",
            "Esse cargo não tem uma cor definida"
          );
        }
      ...
      case "info": {
        cor = opcoes.info.cor;
        if (!/^#([a-fA-F0-9]{6})$/.test(cor)) {
          return client.responder(
            iCmd,
            "bloqueado",
            "Hex inválido",
            "Você deve enviar um hex válido\n(ex: `#aacbff`, `#faff6b`, `#7e6add`)"
          );
        }
