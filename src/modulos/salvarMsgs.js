...
module.exports = async () => {
    ...
    if (fixadosCanal) {
        try {
            ...
            let fixados = await fetchAll(fixadosCanal, { limiteReq: 25, apenasUsuario: true, invertido: true });
    ...
    if (bichinhosCanal) {
        try {
            ...
            let bichinhos = await fetchAll(bichinhosCanal, { limiteReq: 25, apenasUsuario: true, invertido: true });
