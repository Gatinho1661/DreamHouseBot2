...
module.exports = {
  ...
  async executar() {
    ...
    if (client.config.get("salvarMsgs") === true) {
      client.log("bot", "Modulo de Salvar Mensagens ativado"), salvarMsgs();
    } else {
      client.log("bot", "Modulo de Salvar mensagens desativado", "aviso");
    }

    if (client.config.get("aniversarios", "ativado") === true) {
      client.log("bot", "Modulo de Aniversários ativado"), aniversarios();
    } else {
      client.log("bot", "Modulo de aniversários desativado", "aviso");
    }
